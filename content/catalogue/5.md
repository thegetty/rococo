...
{{< q-figure-group grid="2" id="fig-5-11, fig-5-12" class="pdf-one-column" >}}
...
{{< q-figure-group id="fig-5-14, fig-5-15" caption="Cross-section photomicrograph of the European lacquer in visible light (top) and ultraviolet illumination (bottom) showing the layer structure of the original ground, original pigmented and transparent varnishes, and later restorations." >}}
