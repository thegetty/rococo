...
The sliding mechanism for the top and case is activated with a second, smaller key that is inserted into an additional keyhole on the right side, beneath the one used to wind the mechanism ([fig. 18-a](#fig-18-a)). Turning the key moves a lever that is mounted on a long iron plate, housed in the upper case bottom ([fig. 18-b](#fig-18-b)). Moving the lever releases a catch at the center of the bottom of the sliding drawer case, allowing the case to slide forward, propelled by the springs.

{{< q-figure id="fig-18-a" >}}

{{< q-figure id="fig-18-b" >}}
